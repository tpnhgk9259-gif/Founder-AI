            ...
            <table className="w-full text-sm" style={{ borderCollapse: "collapse" }}>
              <thead>
                <tr>
                  ...
                  <th className="text-center px-2 py-2 text-[10px] font-medium tracking-[0.12em] uppercase cursor-help" title={"Le besoin est-il brulant pour ce segment ? 1 = pas urgent, 5 = critique"} style={{ fontFamily: "var(--uf-mono)", color: "#E8358E", borderBottom: "2px solid var(--uf-ink)" }}>Urgence</th>
                  <th className="text-center px-2 py-2 text-[10px] font-medium tracking-[0.12em] uppercase cursor-help" title={"Facilite d'acces au segment : reseaux, canaux, cout d'acquisition. 1 = tres difficile, 5 = acces direct"} style={{ fontFamily: "var(--uf-mono)", color: "#6E4BE8", borderBottom: "2px solid var(--uf-ink)" }}>{"Accessibilit\u00E9"}</th>
                  <th className="text-center px-2 py-2 text-[10px] font-medium tracking-[0.12em] uppercase cursor-help" title={"Taille du gain potentiel : revenus, volume, valeur strategique. 1 = faible, 5 = tres eleve"} style={{ fontFamily: "var(--uf-mono)", color: "#FF6A1F", borderBottom: "2px solid var(--uf-ink)" }}>Potentiel</th>
                  <th className="text-center px-2 py-2 text-[10px] font-medium tracking-[0.12em] uppercase cursor-help" title={"Intensite concurrentielle sur ce segment. 1 = marche sature, 5 = ocean bleu (peu ou pas de concurrents)"} style={{ fontFamily: "var(--uf-mono)", color: "#0DB4A0", borderBottom: "2px solid var(--uf-ink)" }}>Concurrence</th>
